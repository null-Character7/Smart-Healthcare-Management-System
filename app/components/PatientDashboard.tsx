...
export function PatientDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setLoading(true);
      try {
        const [appointmentsRes, prescriptionsRes, doctorsRes] =
          await Promise.all([
        ...
        setPrescriptions(
          prescriptionsRes.data.filter((p: any) => p.confirmed === true)
        );
  ...
  const bookAppointment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Display the toast with date and timeSlot
        toast({
          title: "Appointment added",
          description: `Your appointment is scheduled for ${formattedDate} at ${selectedSlot}`,
        });
